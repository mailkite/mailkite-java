...
<h1 align="center">MailKite for Java</h1>
...
<p align="center">
  ...
  <br>The official <a href="https://mailkite.dev">MailKite</a> library for Java.
</p>
...
<p align="center"><a href="https://central.sonatype.com/artifact/dev.mailkite/mailkite"><img src="https://img.shields.io/maven-central/v/dev.mailkite/mailkite?color=2563eb&label=Maven%20Central" alt="Maven Central"></a></p>
...
| --- | --- |
| [`examples/AgentEmailReply.java`](examples/AgentEmailReply.java) | An AI email agent: inbound email → Claude drafts a reply → MailKite sends it, threaded. |
| [`examples/AgentInbox.java`](examples/AgentInbox.java) | Give your agent its own email address — MailKite's built-in inbox agent answers mail for… |
| [`examples/ReceiveWebhook.java`](examples/ReceiveWebhook.java) | Receive inbound email as a webhook — and VERIFY the HMAC signature before trusting it. |
| [`examples/SendEmail.java`](examples/SendEmail.java) | Send an email over a verified domain — the 10-second "it works". |
| [`examples/ServerLogin.java`](examples/ServerLogin.java) | Server-side login + register — your own account, or your users' accounts via OAuth 2.1 +… |
...
| MailKite for Java **(this repo)** | [`mailkite-java`](https://github.com/mailkite/mailkite-java) | Maven Central |
