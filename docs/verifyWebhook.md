...
```java
Object res = mk.verifyWebhook(Map.of("signature", "t=1750000000000,v1=3d790f831e170ddba4d001f27532bf2c1fc68ebed52eef72fe453dfa1196b03c", "payload", "{"type":"email.received","id":"evt_123","message":"It works."}", "secret", "whsec_mailkite_test", "toleranceMs", 0));
```
